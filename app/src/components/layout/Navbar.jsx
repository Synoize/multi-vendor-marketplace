...
export default function Navbar() {
  ...
  const siteName = useSettings().site_name;
  ...
  // Keep the search input in sync with the ?search= URL param so it always
  // reflects the active search instead of going blank after navigating.
  ...
  const placeholders = [
    ...
    "Search for sports products",
    "Search for fitness gear",
    "Search for toys",
    "Search for gifts",
    "Search for best sellers",
    "Search for deals & offers",
  ];
