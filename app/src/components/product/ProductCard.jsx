...
const RatingStars = memo(function RatingStars({ rating, size = "sm" }) {
...
const ProductCard = memo(function ProductCard({ product, onWishlistChange, onClick }) {
  ...
  const isLowStock = !isOutOfStock && stockNum > 0 && stockNum < 10;
  ...
  return (
    ...
    >
      ...
      {/* Product Image */}
      <div className="aspect-square overflow-hidden bg-secondary-50 relative flex items-center justify-center">
        <img
          src={
        ...
        {isOutOfStock && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <span className="bg-black/70 text-white text-[11px] font-bold uppercase tracking-wide px-3 py-1.5 rounded">
              Sold Out
            </span>
          </div>
        )}
