        ...
        <div className="max-w-4xl mx-auto px-4 pb-10 sm:pb-14">
          <div className="relative rounded-[28px] bg-gradient-to-br from-primary to-accent overflow-hidden py-10 sm:py-14 px-6">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <p className="text-secondary text-sm sm:text-base font-medium max-w-lg text-center mb-8">
                One platform, thousands of neighborhood shops — bringing local
                businesses closer to customers across India.
              </p>
                ...
                ({ year, title, icon: Icon, desc, current, beyond }) => (
                  <div key={year} className="relative flex gap-5 sm:gap-6">
                    ...
                    <div className="pt-1">
                      ...
                      <p className="text-secondary-900 text-xs sm:text-sm font-thin leading-relaxed max-w-xl">
                        {desc}
                      </p>
                    </div>
                  </div>
