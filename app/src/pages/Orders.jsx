                    ...
                    <div className="flex flex-col justify-between items-end gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        <a
                          ...
                          className="inline-flex items-center gap-1 bg-[#25D366] text-white px-2 py-1 rounded-lg text-[10px] font-medium hover:brightness-95 transition-all"
                          title="Send thank you note on WhatsApp"
                        >
                          <img
                            src={whatsappIcon}
                            alt="WhatsApp"
