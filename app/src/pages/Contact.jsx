...
export default function Contact() {
  ...
  const contactCards = buildContactCards(settings);
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - {settings.site_name} Marketplace</title>
        <meta
          name="description"
          content={`Get in touch with ${settings.site_name} support. Call, email, or visit us. We're here to help 24/7.`}
        />
      </Helmet>
