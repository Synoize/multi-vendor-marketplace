...
const MEASURES = [
  {
    ...
    desc: "All data transmitted between your browser and our servers is encrypted using industry-standard TLS/SSL protocols.",
  },
  {
    icon: Server,
    title: "Secure Infrastructure",
    desc: "Our servers are hosted on enterprise-grade cloud infrastructure with multiple layers of security and regular audits.",
  },
  {
    icon: Key,
    title: "Password Hashing",
    desc: "Passwords are hashed using bcrypt with salt, ensuring they cannot be read even in the event of a data breach.",
  },
  {
    icon: Eye,
    title: "Access Control",
    desc: "Personal data is accessible only to authorized personnel on a need-to-know basis with role-based permissions.",
  },
  {
    icon: FileCheck,
    title: "PCI-DSS Compliance",
    desc: "Payment processing is handled by PCI-DSS compliant gateways. Card details are tokenized and never stored on our servers.",
  },
  {
    icon: ShieldCheck,
    title: "Regular Audits",
    desc: "We conduct periodic security audits, vulnerability assessments, and penetration testing to identify and fix threats.",
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about the security measures and data protection practices at The Damini Edit Marketplace."
        />
      </Helmet>
        ...
        <div className="max-w-4xl mx-auto py-6">
          <div className="bg-white rounded-xl shadow-sm border border-secondary p-5 sm:p-8 mb-6">
            <p className="text-secondary-800 text-sm leading-relaxed">
              At The Damini Edit, we take security seriously. Our platform is
              built with multiple layers of protection to safeguard your
              personal information, payment data, and browsing activity. We
              follow industry best practices and comply with applicable data
