...
export default function SellerRegister() {
  ...
  const isUnderReview =
    vendorStatus === "pending"
      ? !!user?.store_name
      : vendorStatus === "submitted" || vendorStatus === "under_review";
  ...
  const handleReApply = async () => {
    setShowForm(true);
    try {
      const existing = await fetchKycData();
      if (existing) {
        const {
          business_name,
          business_type,
  ...
  return (
    <>
      ...
      {/* Hero */}
      <div className="bg-gradient-to-b from-primary-50/60 to-white text-secondary py-6 sm:pt-8 lg:pt-12 px-4">
        <div className="max-w-4xl mx-auto text-center relative rounded-[28px] bg-gradient-to-br from-primary to-accent overflow-hidden py-10 sm:py-14 px-6">
          <svg
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 sm:py-8">
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 text-center">
            ...
            <h2 className="text-xl font-semibold text-secondary-950 mb-1">
              Admin accounts can't become a seller
            </h2>
            <p className="text-secondary-700 text-sm mb-5">
              This account is registered as an admin. Please use a customer or
              vendor account to apply as a seller.
            </p>
            <Link
              to="/profile"
              className="border border-secondary-300 text-secondary-900 px-6 sm:px-8 py-3 rounded-xl text-xs hover:bg-secondary-50 transition-colors inline-block"
            >
              Go to My Profile
            </Link>
          </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          update("fssai_number", e.target.value.toUpperCase())
                        }
                        maxLength={14}
                        placeholder="14-digit FSSAI no. (optional)"
                        className="w-full border rounded-lg px-3 sm:px-4 py-2.5 text-xs sm:text-sm uppercase outline-none focus:border-secondary-600"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          update("ifsc_code", e.target.value.toUpperCase())
                        }
                        maxLength={11}
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {files[doc.key] ? (
                                ...
                                <div className="mt-2 flex items-center gap-2 bg-green-50 rounded-lg px-3 py-1.5">
                                  <CheckCircle className="h-3 w-3 text-green-600 flex-shrink-0" />
                                  <span className="text-[11px] text-green-700 truncate flex-1">
                                    Already uploaded
                                  </span>
                                  <button
                                    type="button"
                ...
                <div className="text-center py-2 sm:py-4">
                  ...
                  <div className="bg-secondary rounded-lg p-4 text-left text-sm space-y-2.5 mb-4">
                    {[
                      ...
                      {
                        label: "FSSAI",
                        value: form.fssai_number || "Not provided",
                        sensitive: true,
                      },
