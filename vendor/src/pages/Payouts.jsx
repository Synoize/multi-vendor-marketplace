            ...
            <div className="bg-gradient-to-r from-primary-600 to-primary-500 rounded-xl p-6 text-white shadow-md flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-secondary-400 text-xs mt-2">
                  Eligible earnings (delivered & past return window). Released
                  automatically each week once the minimum payout threshold is
                  met.
                </p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl border border-gray-100 p-5 space-y-3">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                account weekly. A delivered order is only eligible after its
                return window expires and returns are settled. Payouts above
                the minimum threshold are released automatically each cycle.
              </p>
            </div>
          </div>
        </div>
