...
export default function Ads() {
  ...
  const handleApprove = (id) => {
    if (actionLock.current || approveMutation.isPending || rejectMutation.isPending) return;
    actionLock.current = true;
    approveMutation.mutate(id, { onSettled: () => { actionLock.current = false; } });
  };
  ...
  const handleRejectSubmit = () => {
    ...
    actionLock.current = true;
    rejectMutation.mutate({ id: rejectModal, reason: rejectReason }, { onSettled: () => { actionLock.current = false; } });
  };
