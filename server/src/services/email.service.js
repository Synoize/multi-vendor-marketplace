...
const transporter = nodemailer.createTransport({
  ...
  auth    : {
    user : mailCfg.user,
    pass : mailCfg.pass,       // Gmail App Password
  },
});
...
const sendOTPEmail = async (email, name, otp) => {
  ...
  const html    = buildHtml('Verify Your Email', `
...
const sendWelcomeEmail = async (email, name) => {
  ...
  const html    = buildHtml('Welcome to Damini', `
    ...
    <a class="btn" href="https://daminishop.com/products">Start Shopping</a>
...
const sendOrderPlacedEmail = async (email, name, order) => {
  ...
  const html    = buildHtml('Order Confirmed', `
    ...
    <a class="btn" href="https://daminishop.com/orders/${order.id}">Track Order</a>
...
const sendOrderShippedEmail = async (email, name, order, trackingId) => {
  ...
  const html    = buildHtml('Order Shipped', `
    ...
    <a class="btn" href="https://daminishop.com/orders/${order.id}">Live Track</a>
...
const sendOrderDeliveredEmail = async (email, name, order) => {
  ...
  const html    = buildHtml('Order Delivered', `
    ...
    <a class="btn" href="https://daminishop.com/orders/${order.id}/review">Write a Review</a>
...
const sendOrderCancelledEmail = async (email, name, order) => {
  ...
  const html    = buildHtml('Order Cancelled', `
    ...
    <a class="btn" href="https://daminishop.com/products">Continue Shopping</a>
    <p style="font-size:13px;color:#888;">Questions? Contact support@daminishop.com</p>
  `);
  return sendMail(email, subject, html);
};
...
const sendRefundInitiatedEmail = async (email, name, refund) => {
  ...
  const html    = buildHtml('Refund Initiated', `
    ...
    <a class="btn" href="https://daminishop.com/orders">View Orders</a>
  `);
  return sendMail(email, subject, html);
};
...
const sendPayoutReleasedEmail = async (email, vendorName, amount) => {
  ...
  const html    = buildHtml('Payout Released', `
    ...
    <a class="btn" href="https://daminishop.com/vendor/payments">View Payout History</a>
    <p style="font-size:13px;color:#888;">Vendor Support: vendor-support@daminishop.com</p>
  `);
  return sendMail(email, subject, html);
};
...
const sendReturnApprovedEmail = async (email, name, returnData) => {
  ...
  const html    = buildHtml('Return Approved', `
    ...
    <a class="btn" href="https://daminishop.com/orders">Track Return</a>
