...
router.use(protect, requireRole('admin'), rateLimit('admin'));
...
router.patch('/vendors/:id/commission', adminController.updateVendorCommission);
router.get('/vendors/:id/pickup', adminController.getVendorPickupStatus);
router.post('/vendors/:id/pickup/retry', adminController.retryVendorPickup);
router.post('/vendors/:id/pickup/re-register', adminController.forceReregisterVendorPickup);
...
router.get('/payouts/preview', adminController.previewPayoutCycle);
router.post('/payouts/release', adminController.releasePayout);
router.post('/payouts/settle-vendor', adminController.settleOneVendor);
router.post('/payouts/run-cycle', adminController.runPayoutCycle);
