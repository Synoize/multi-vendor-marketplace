 ...
 */
router.post('/image', protect, rateLimit('upload'), uploadProductImages, uploadController.uploadImage);

/**
 * POST /upload/images
 * Upload multiple images, returns array of URLs
 */
router.post('/images', protect, rateLimit('upload'), uploadProductImages, uploadController.uploadImages);
...
router.post('/image/:kind', protect, rateLimit('upload'), resolveKindUploader, uploadController.uploadKindImage);
